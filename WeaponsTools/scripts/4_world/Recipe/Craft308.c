...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"AR15_CIV");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"ConversionKit308_Civ");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AR15_CIV_308");//add results here

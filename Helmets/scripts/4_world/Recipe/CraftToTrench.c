class CraftToTrench extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Adjust Straps";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_M1917brodieSniper");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_M1917brodieTrench");//add results here

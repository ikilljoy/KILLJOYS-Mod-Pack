class CraftToSniper extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_M1917brodie");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_M1917brodieSniper");//add results here

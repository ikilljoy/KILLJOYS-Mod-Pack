class Craft308 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Convert to .308";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_AR15_CIV");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"KMP_ConversionKit308_Civ");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_AR15_CIV_308");//add results here

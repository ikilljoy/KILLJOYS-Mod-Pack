class DismantleBBDisplayCase extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_BBDisplayCase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_BBDisplayCase_Kit");//add results here

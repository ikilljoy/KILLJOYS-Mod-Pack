class DismantleFootLocker extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_FootLocker");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_FootLocker_Kit");//add results here

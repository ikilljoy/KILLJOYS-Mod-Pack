class DismantleGunWall extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_GunWall");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_GunWall_Kit");//add results here

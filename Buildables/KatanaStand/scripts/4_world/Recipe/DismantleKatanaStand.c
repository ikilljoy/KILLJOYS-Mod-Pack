class DismantleKatanaStand extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_KatanaStand");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_KatanaStand_Kit");//add results here

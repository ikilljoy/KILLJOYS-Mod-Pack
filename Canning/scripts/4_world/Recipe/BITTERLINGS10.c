class BITTERLINGS10 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_Mush_BITTERLINGS");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarBITTERLING_9");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarBITTERLING_10");//add results here

		m_ResultSetFullQuantity[0] = true;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[0] = 70;//-1 = do nothing

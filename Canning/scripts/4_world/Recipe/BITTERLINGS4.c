class BITTERLINGS4 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarBITTERLING_3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarBITTERLING_4");//add results here

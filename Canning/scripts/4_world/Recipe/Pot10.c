class Pot10 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_MUSH_Pot");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarPOT_9");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarPOT_10");//add results here

class APPLE10 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"KMP_MUSH_APPLE");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarAPPLE_9");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarAPPLE_10");//add results here

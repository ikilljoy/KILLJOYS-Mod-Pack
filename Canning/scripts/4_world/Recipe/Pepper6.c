class Pepper6 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarPEPPER_5");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarPEPPER_6");//add results here

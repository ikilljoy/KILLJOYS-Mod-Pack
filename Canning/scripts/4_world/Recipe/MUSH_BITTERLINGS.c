class MUSH_BITTERLINGS extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Process food";
		...
		//ingredient 2
		InsertIngredient(1,"KMP_FoodProcessor");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_Mush_BITTERLINGS");//add results here

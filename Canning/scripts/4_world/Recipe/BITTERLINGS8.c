class BITTERLINGS8 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarBITTERLING_7");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarBITTERLING_8");//add results here

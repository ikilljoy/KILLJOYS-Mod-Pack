class APPLE3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add to jar";
		...
		//ingredient 2
		InsertIngredient(1,"KMP_JarAPPLE_2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("KMP_JarAPPLE_3");//add results here
